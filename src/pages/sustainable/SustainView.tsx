                        ...
                        <Row>
                            <Col lg="12" md="12">
                                <Row className="substain-h-wrapper pb-3 ">
                                    <Col lg="9" md="12">
                                        <h1 className="mb-0 text-capitalize fw-semibold font-28">Transportation emissions dashboard</h1>
                                    </Col>
                                    <Col lg="3" md="12">
                                            ...
                                            <Col lg="3">
                                                <div className="primaryCard p-4 h-100">
                                                    <div className="primaryCardInnerWprpper">
                                                        ...
                                                        <h6 className="font-14">{getCompanyName(dataCheck?.userdata)} </h6>
                            ...
                            <Row className="g-3">
                                <Col lg="6">
                                    <div className="mainGrayCards p-3 h-100 slider-icons position-relative">
                                        ...
                                        <div className="track-btnWrapper d-flex align-items-center mb-2 justify-content-between">
                                            <h3 className="fw-semibold mb-0"> Reduction Glide Path <span className="fw-light">({!checkedEmissionsReductionGlide ? 'gCO2e' : 'tCo2e'})</span></h3>
                                            <Button className="px-4 py-0 ms-4">
                                                On track
                                            </Button>
                                        </div>
                                        <div>
                                        ...
                                        {regionEmissionIsloading ? <div className="graph-loader d-flex justify-content-center ">
                                ...
                                <Col lg="6">
                                    <div className="mainGrayCards p-3 h-100 position-relative">
                                        ...
                                        {
                                            emissionIntensityDetailsIsLoading ? <div className="graph-loader d-flex justify-content-center ">
                                    ...
                                    <div className="mainGrayCards p-3 h-100 position-relative">
                                        <div className="d-md-block d-lg-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 className="fw-semibold mb-0">Emissions Intensity by Region <span>
                                                    (gCO2e/Ton-Mile of freight)
                                                </span></h3>
                                            </div>
                                            <div>
                                ...
                                <Col lg="12">
                                    <Row>
                                        <Col xl="3" lg="4">
                                            ...
                                            <h3 className="fw-semibold text-capitalize mb-0">Projects overview</h3>
                                        </Col>
                                        <Col xl="3" lg="4">
                                            <div>
