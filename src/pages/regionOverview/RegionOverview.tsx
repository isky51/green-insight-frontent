                ...
                <div className="mainGrayCards p-3 h-100 slider-icons position-relative">
                  <div className="emi-inten ">
                    ...
                    <div className="d-flex justify-content-between mb-3">
                      <div>
                        <h3 className="fw-semibold">Modal Overview</h3>
                      </div>
                      ...
                      <div className="d-flex justify-content-end ">
                        <div>
                          <div className="d-flex align-items-center mb-2">
                            <div className="primary-div me-2">
                            </div>
              ...
              <Col lg="6">
                <div className="mainGrayCards p-3 h-100 slider-icons position-relative">
                  <div className="emi-inten">
                    ...
                    <h3 className="fw-semibold mb-2">Carrier Emissions</h3>

                    <div className="emi-inten d-flex justify-content-between  pb-4">
                      <div className="d-flex align-items-center">
                        <h5 className="mb-0 fw-semibold font-14">
                          Emissions Intensity
                        </h5>
                        <div className="toggle-switch fw-semibold mt-1">
                          <Form>
                            <Form.Check
                              type="switch"
                              id="custom-switch"
                ...
                <div className="mainGrayCards p-3 h-100 slider-icons position-relative">
                  <div className=" p-3 px-3">
                    <div className="emi-inten">
                      ...
                      <h6 className="datafrom-txt mb-2 font-14">
                      ...
                      <h3 className="fw-semibold mb-2">Lane Emissions</h3>
                  ...
                  <div className="mainGrayCards p-3 h-100 slider-icons position-relative">
                    <div className=" p-3 px-3">
                      <div className="emi-inten">
                        ...
                        <h3 className="fw-semibold mb-2">Facility Emissions</h3>
                      </div>

                      <div className="emi-inten d-flex justify-content-between pb-4">

                        <div className="d-flex align-items-center">
                          <h6 className="mb-0 fw-semibold font-14">
                            Emissions Intensity
                          </h6>
                          <div className="toggle-switch mt-1">
